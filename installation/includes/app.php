...
// @todo: Should be removed in 7.0 as no longer needed (installation router has service provider)
...
$container->registerServiceProvider(new \Joomla\CMS\Installation\Service\Provider\Application())
    ->registerServiceProvider(new \Joomla\CMS\Installation\Service\Provider\Router());
