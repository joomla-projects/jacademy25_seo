...
## Docker
The system tests can also be executed in headless mode with docker compose. The following command starts the system tests from the current docker-compose.yml file:
