...
$loginLogoAlt = empty($this->params->get('loginLogoAlt')) && empty($this->params->get('emptyLoginLogoAlt'))
    ? ''
    : htmlspecialchars((string) $this->params->get('loginLogoAlt', ''), ENT_COMPAT, 'UTF-8');
...
if ($colorScheme) {
    ...
    if ($userLastMode && (isset($themeModes[$userLastMode]) && ($themeModes[$userLastMode] !== '' && $themeModes[$userLastMode] !== '0'))) {
