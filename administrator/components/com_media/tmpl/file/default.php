...
$config = [
    ...
    'imagesExtensions'   => array_map('trim', explode(',', (string) $params->get('image_extensions', 'bmp,gif,jpg,jpeg,png,webp,avif'))),
    'audioExtensions'    => array_map('trim', explode(',', (string) $params->get('audio_extensions', 'mp3,m4a,mp4a,ogg'))),
    'videoExtensions'    => array_map('trim', explode(',', (string) $params->get('video_extensions', 'mp4,mp4v,mpeg,mov,webm'))),
    'documentExtensions' => array_map('trim', explode(',', (string) $params->get('doc_extensions', 'doc,odg,odp,ods,odt,pdf,ppt,txt,xcf,xls,csv'))),
