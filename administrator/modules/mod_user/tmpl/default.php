    ...
    data-bs-auto-close="outside" title="<?php echo Text::_('MOD_USER_MENU'); ?>">
        <span class="header-item-icon">
            <!-- <span class="icon-user-circle" aria-hidden="true"></span> -->
             <svg class="j-icon" aria-hidden="true"><use href="#<?= HTMLHelper::_('svgicon.add', 'j--circle-user'); ?>"></svg>
        </span>
        <span class="header-item-text">
            <?php echo Text::_('MOD_USER_MENU'); ?>
        </span>
        <!-- <span class="icon-angle-down" aria-hidden="true"></span> -->
         <svg class="j-icon" aria-hidden="true"><use href="#<?= HTMLHelper::_('svgicon.add', 'j--angle-down'); ?>"></svg>
    </button>
    <div class="dropdown-menu dropdown-menu-end">
        ...
        <a class="dropdown-item" href="<?php echo Route::_($route); ?>">
            <!-- <span class="icon-user icon-fw" aria-hidden="true"></span> -->
             <svg class="j-icon" aria-hidden="true"><use href="#<?= HTMLHelper::_('svgicon.add', 'j--user'); ?>"></svg>
        ...
        <?php if ($colorSchemeSwitch) : ?>
            <button type="button" class="dropdown-item" data-color-scheme-switch>
                <span class="d-dark-scheme-none">
                    <!-- <span class="fa fa-sun icon-fw me-1" aria-hidden="true"></span> -->
                     <svg class="j-icon" aria-hidden="true"><use href="#<?= HTMLHelper::_('svgicon.add', 'j--sun'); ?>"></svg>
                     <?php echo Text::_('MOD_USER_LIGHTDARK_MODE'); ?>
                </span>
                <span class="d-light-scheme-none">
                    <!-- <span class="fa fa-moon icon-fw me-1" aria-hidden="true"></span> -->
                     <svg class="j-icon" aria-hidden="true"><use href="#<?= HTMLHelper::_('svgicon.add', 'j--moon'); ?>"></svg>
                     <?php echo Text::_('MOD_USER_LIGHTDARK_MODE'); ?>
                </span>
            </button>
        <?php endif; ?>
        ...
        <a class="dropdown-item" href="<?php echo Route::_($route); ?>">
            <!-- <span class="icon-universal-access icon-fw" aria-hidden="true"></span> -->
             <svg class="j-icon" aria-hidden="true"><use href="#<?= HTMLHelper::_('svgicon.add', 'j--universal-access'); ?>"></svg>
        ...
        <a class="dropdown-item" href="<?php echo Route::_($route); ?>">
            <!-- <span class="icon-power-off icon-fw" aria-hidden="true"></span> -->
             <svg class="j-icon" aria-hidden="true"><use href="#<?= HTMLHelper::_('svgicon.add', 'j--power-off'); ?>"></svg>
