...
$input = '<input type="text" name="q" id="mod-finder-searchword' . $module->id . '" class="js-finder-search-query form-control" value="' . htmlspecialchars((string) $app->getInput()->get('q', '', 'string'), ENT_COMPAT, 'UTF-8') . '"'
